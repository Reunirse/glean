...
* You can’t use the trait if you need access to command line arguments.
* Because of some restrictions of JVM threading model, you need an explicit main method, if the program is multithreaded.
